...
terceira_acao = primeiro_menu.addAction("Terceira ação")
terceira_acao.triggered.connect(quarto_slot(segunda_action))  # type:ignore

botao1.clicked.connect(terceiro_slot(segunda_action))  # type:ignore
botao2.clicked.connect(terceiro_slot(segunda_action))  # type:ignore
botao3.clicked.connect(quarto_slot(terceira_acao))  # type:ignore
